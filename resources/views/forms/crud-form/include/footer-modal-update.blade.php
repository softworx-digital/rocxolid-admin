<div class="modal-footer">
    ...
    <div class="btn-group pull-right">
        <button type="button" class="btn btn-success" data-ajax-submit-form="{{ $component->makeDomIdHash('modal-update') }}"><i class="fa fa-save margin-right-10"></i>{{ $component->translate('button.save', false) }}</button>
