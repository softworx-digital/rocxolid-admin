<div class="modal-footer">
    ...
    @if ($component->getForm()->getModel()->canBeDeleted())
        <button data-dismiss="modal" data-ajax-url="{{ $component->getForm()->getModel()->getControllerRoute('destroyConfirm') }}" class="btn btn-danger"><i class="fa fa-trash margin-right-10"></i>{{ $component->translate('button.delete') }}</button>
    @endif
    </div>
</div>