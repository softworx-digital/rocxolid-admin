...
<div class="btn-group submit-actions pull-right">
    <button type="button" class="btn btn-success" data-ajax-submit-form="{{ $component->getDomIdHash('modal-create') }}" data-submit-action="submit"><i class="fa fa-save margin-right-10"></i>{{ $component->translate('button.create') }}</button>
