{{ Form::open([ 'id' => $component->getDomId('modal-clone') ] + $component->getOptions()->except(['scripts'])->toArray()) }}
    ...
    <div class="modal-footer">
        {!! $component->render(sprintf('modal.footer.%s', $component->getOption('modal-footer-template', 'clone'))) !!}
    </div>
{{ Form::close() }}
